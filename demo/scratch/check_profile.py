...
income = 300000
loan_amount = 200000
credit_score = 450  # Default in app
months_employed = 12
num_credit_lines = 5  # Default
interest_rate = 22.5  # Default
loan_term = 60  # Default
...
raw_input = {
    ...
    'LoanTerm': loan_term, 'DTIRatio': dti_ratio, 'Education': "Master's", 'EmploymentType': "Full-time",
    'MaritalStatus': "Married", 'HasMortgage': "No", 'HasDependents': "No",
...
top_features = get_top_features_for_case(shap_values, X_input, idx=0, top_n=8)
